...
# written 2025-05-02
# taxon <- int_species[1]
accersi_taxon_occurrences_per_bin_from_pbdb_finds <- function(taxon,paleodb_finds,paleodb_sites,chronostrat)	{
...
if (nrow(taxon_finds)>0)	{
	...
	while (mb < nrow(multibin_sites))	{
		tspan <- abs(multibin_sites$ma_lb-multibin_sites$ma_ub);
		occurrence_vector[multibin_sites$bin_lb[mb]] <- occurrence_vector[multibin_sites$bin_lb[mb]] + (multibin_sites$ma_lb-chronostrat$ma_ub[multibin_sites$bin_lb])/tspan;
		occurrence_vector[multibin_sites$bin_ub[mb]] <- occurrence_vector[multibin_sites$bin_ub[mb]] + (chronostrat$ma_ub[multibin_sites$bin_lb]-multibin_sites$ma_ub)/tspan;
...
# written 2025-05-02
# paleodb_finds <- single_bin_finds; paleodb_sites <- single_bin_sites; chronostrat <- interval_chronostrat; study_taxa <- int_species;
